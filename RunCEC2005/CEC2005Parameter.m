...
function func_name = getFunctionData(func_num)
    ...
    elseif func_num==3 func_name = ('high_cond_elliptic_rot_func'); %[-100,100]
    elseif func_num==4 func_name = ('schwefel_102_noise_func'); %[-100,100]
    elseif func_num==5 func_name = ('schwefel_206'); %[no bound],initial[-100,100];
    elseif func_num==6 func_name = ('rosenbrock_func'); %[-100,100]
    elseif func_num==7 func_name = ('griewank_rot_func'); %[-600,600]
    elseif func_num==8 func_name = ('ackley_rot_func'); %[-32,32]
    elseif func_num==9 func_name = ('rastrigin_func'); %[-5,5]
    elseif func_num==10 func_name = ('rastrigin_rot_func'); %[-5,5]
    elseif func_num==11 func_name = ('weierstrass_rot'); %[-0.5,0.5]
    ...
    elseif func_num==16 func_name = ('hybrid_rot_func1'); %[-5,5]
    elseif func_num==17 func_name = ('hybrid_rot_func1_noise'); %[-5,5]        
    elseif func_num==18 func_name = ('hybrid_rot_func2'); %[-5,5]    
    elseif func_num==19 func_name = ('hybrid_rot_func2_narrow'); %[-5,5]    
    elseif func_num==20 func_name = ('hybrid_rot_func2_onbound'); %[-5,5]  
    elseif func_num==21 func_name = ('hybrid_rot_func3'); %[-5,5]    
    elseif func_num==22 func_name = ('hybrid_rot_func3_highcond'); %[-5,5]  
    elseif func_num==23 func_name = ('hybrid_rot_func3_noncont'); %[-5,5]   
    elseif func_num==24 func_name = ('hybrid_rot_func4'); %[-5,5]  
    elseif func_num==25 func_name = ('hybrid_rot_func4'); %[-5,5]  
    end
end
