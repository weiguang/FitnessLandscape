...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function S_MSE= Salomon(FVr_temp, S_struct)
...
%    F_cost1  = F_cost1 + abs(FVr_temp(i));
%    F_cost2  = F_cost2 * abs(FVr_temp(i));
%    %F_cost + ((FVr_temp(i))^2-10*cos(2*pi*FVr_temp(i)));
% end
F_cost = -cos(2*pi*sqrt(sum(FVr_temp.^2)))+0.1*sqrt(sum(FVr_temp.^2))+1;
