...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function S_MSE= Beale(FVr_temp, S_struct)
...
% end
F_cost = (1.5 - FVr_temp(1) + FVr_temp(1)*FVr_temp(2))^2 + (2.25 - FVr_temp(1)+ FVr_temp(1)* (FVr_temp(2)^2))^2 + (2.625 - FVr_temp(1) + FVr_temp(1)* (FVr_temp(2)^3))^2;
