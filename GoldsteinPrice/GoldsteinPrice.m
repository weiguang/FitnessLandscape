...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function S_MSE= GoldsteinPrice(FVr_temp, S_struct)
...
% end
F_cost = (1+(FVr_temp(1)+FVr_temp(2)+1)^2 * (19-14*FVr_temp(1) + 3*(FVr_temp(1)^2)-14*FVr_temp(2) + 6*FVr_temp(1)*FVr_temp(2) + 3*(FVr_temp(2)^2)))...
                *(30+ (2*FVr_temp(1)-3*FVr_temp(2))^2 ...
                *(18-32*FVr_temp(1) + 12*(FVr_temp(1)^2) + 48*FVr_temp(2) - 36*FVr_temp(1)*FVr_temp(2) + 27*(FVr_temp(2)^2)));
